...
ifeq ($(OS),Windows_NT)
    FEATURES ?= aws-kms gcp-kms turnkey cli asm-keccak optimism risex-risk-precompile
else
    FEATURES ?= jemalloc aws-kms gcp-kms turnkey cli asm-keccak optimism risex-risk-precompile
endif
