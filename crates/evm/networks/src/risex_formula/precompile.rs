...
mod tests {
    ...
    fn populated_success_records_exclusive_loader_subphases_and_reconciled_work() {
        ...
        // The ten-nanosecond StepClock pins 19 key operations and 25 loader
        ...
        assert_eq!(record["key_derivation_cpu_ns"], 190);
    ...
    fn late_loader_failure_records_completed_loader_phases_without_partial_output() {
        ...
        // The late missing-price exit still completed 20 key operations, 26
